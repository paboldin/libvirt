                                         ...
                                         unsigned int flags)
{
    ...
    if (call(dconn, priv, 0, REMOTE_PROC_DOMAIN_MIGRATE_PREPARE_TUNNELS3_PARAMS,
             (xdrproc_t) xdr_remote_domain_migrate_prepare_tunnels3_params_args,
             (char *) &args,
             (xdrproc_t) xdr_remote_domain_migrate_prepare_tunnels3_params_ret,
             (char *) &ret) == -1) {
        goto cleanup_netsts;
    }
